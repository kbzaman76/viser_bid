...
.nav--tabs li a.active, .sidebar-countdown li, .form--check .form-check-input:checked, .side__menu li a.active, .side__menu li a:hover, .cmn--btn.active, .account__section-content .form-control:focus, .client-slider__arrow:hover {
...
*::selection, .client-slider__arrow:hover {
