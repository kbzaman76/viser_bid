                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-none-15">
                            ...
                            <div class="col-12 mb-15 mb-15">
                                <div class="form-group">
                                    <label class="font-weight-bold">@lang('Long Description') <span class="text-danger">*</span></label>
                                    <textarea rows="8" class="form-control border-radius-5 nicEdit" name="long_description">@php echo $product->long_description @endphp</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
